      ...
      <div className="grid px-6 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {isLoading ? (
          ...
          Array.from({ length: 8 }).map((_, index) => (
            <div key={index} className="bg-white border rounded-xl shadow-sm p-4 flex justify-between items-center">
          ...
          filteredCategories.map((cat) => (
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <Button size="icon" variant="destructive" onClick={() => handleOpenDeleteConfirm(cat.id)}>
